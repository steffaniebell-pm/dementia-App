    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 24 }}>
        ...
        <Card style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 16 }}>
          ...
          <AccessibilityText style={{ flex: 1, fontSize: 14, color: '#4D217A' }}>{tip}</AccessibilityText>
        </Card>
        ...
        <Card style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 16 }}>
          <AccessibilityText style={{ fontSize: 24, marginRight: 12 }}>🥗</AccessibilityText>
          <AccessibilityText style={{ flex: 1, fontSize: 17, fontWeight: '600', color: '#4D217A' }}>{recipe.title}</AccessibilityText>
        </Card>
